...
urlpatterns = [
    ...
    path('like-sugg/<int:pk>/',ideabook_views.like_sugg,name='like_sugg'),
    path('<int:pk>/',ideabook_views.ideaview,name='idea'),
    path('user_account/<int:pk>',ideabook_views.useraccountview,name='user_account'),
    ...
    path('search/',ideabook_views.searchview,name='search'),
    path('follow/<int:pk>/',ideabook_views.follow,name='follow'),
